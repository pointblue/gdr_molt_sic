...
# average year differs for each region but 2006 was closes to average for the whole region and looks reasonable
...
ggplot(ma_all_year_results_df, aes(x = year_num, y=full_hr_molt_sic_num)) +
  geom_point() +
  geom_smooth(method="lm") +
  scale_y_continuous(breaks=seq(0,60,by=10)) +
